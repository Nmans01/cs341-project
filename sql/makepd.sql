...
-- -----------------------------------------------------
-- Table `u413142534_project8`.`siteUser`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `u413142534_project8`.`siteUser` ;

CREATE TABLE IF NOT EXISTS `u413142534_project8`.`siteUser` (
...
CREATE TABLE IF NOT EXISTS `u413142534_project8`.`assignment` (
  ...
  PRIMARY KEY (`assignmentDate`, `roomGroup_roomGroupID`, `siteUser_userID`),
  INDEX `fk_assignment_roomGroup1_idx` (`roomGroup_roomGroupID` ASC) VISIBLE,
  INDEX `fk_assignment_siteUser1_idx` (`siteUser_userID` ASC) VISIBLE,
  CONSTRAINT `fk_assignment_roomGroup1`
    FOREIGN KEY (`roomGroup_roomGroupID`)
    REFERENCES `u413142534_project8`.`roomGroup` (`roomGroupID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_assignment_siteUser1`
    FOREIGN KEY (`siteUser_userID`)
    REFERENCES `u413142534_project8`.`siteUser` (`userID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `u413142534_project8`.`formEntry` (
  ...
  CONSTRAINT `fk_formEntry_assignment1`
    FOREIGN KEY (`assignment_assignmentDate`)
    REFERENCES `u413142534_project8`.`assignment` (`assignmentDate`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
